...
class Developer:
    def __init__ (self,root):
        ...
        img_dev=Image.open(r"college_images/peehu.jpg")
        img_dev=img_dev.resize((150,200))
        self.photoimg_dev=ImageTk.PhotoImage(img_dev)

        f_lbl=Label(main_frame,image=self.photoimg_dev)
        f_lbl.place(x=300,y=0,width=200,height=200)

        dev_label=Label(main_frame,text="Hello,My name is Peehu",font=("rockwell",18,"bold"), bg="white")
        dev_label.place(x=0,y=5)

        dev_label=Label(main_frame,text="Developer of this project",font=("rockwell",18,"bold"), bg="white")
        dev_label.place(x=0,y=35)

        img1=Image.open(r"college_images/KPIs-and-Agile-software-development-metrics-for-teams-1.jpg")
