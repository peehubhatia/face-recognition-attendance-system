...
class Face_Recognition:
    def __init__ (self,root):
        ...
        img_top=Image.open(r"college_images/facial-recognition_0.jpg")
        img_top=img_top.resize((765,700))
        ...
        img_bottom=img_bottom.resize((800,700))
    ...
    def face_recog(self):
        ...
        def recognize(img,clf,faceCascade):
            coord=draw_boundary(img,faceCascade,1.1,10,(255,25,255),"data",clf)
            return img
