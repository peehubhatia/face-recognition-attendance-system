...
class Student:
    def __init__ (self,root):
        ...
        img2=Image.open(r"college_images/1_5TRuG7tG0KrZJXKoFtHlSg.jpeg")
        ...
        #background image
        img3=Image.open(r"college_images/1_5TRuG7tG0KrZJXKoFtHlSg.jpeg")
        ...
        left_frame.place(x=0,y=10,width=760,height=480)
        ...
        student_frame.place(x=0,y=110,width=750,height=300)
        ...
        img_right=Image.open(r"college_images/1_5TRuG7tG0KrZJXKoFtHlSg.jpeg")
    ...
    def add_data(self):
        if self.var_dept.get()=="Select" or self.var_name.get()=="" or self.var_id.get=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost", username="root" , password="Peehubhatia@123", database="face_recognition",ssl_disabled=True)
    ...
    # Check if data is long enough before accessing its elements
        if len(data) >= 15:
        ...
        # Handle the case where data is not complete
