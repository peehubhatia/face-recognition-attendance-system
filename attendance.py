...
class Attendence_details:
    def __init__ (self,root):
        ...
        img_top=img_top.resize((800,140))
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=0,y=0,width=800,height=140)

        img_bottom=Image.open(r"college_images/iStock-182059956_18390_t12.jpg")
        img_bottom=img_bottom.resize((800,140))
        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)

        b_lbl=Label(self.root,image=self.photoimg_bottom)
        b_lbl.place(x=800,y=0,width=800,height=140)

        img3=Image.open(r"college_images/AdobeStock_303989091.jpeg")
        ...
        left_frame.place(x=0,y=10,width=680,height=400)

        img_left=Image.open(r"college_images/AdobeStock_303989091.jpeg")
        img_left=img_left.resize((750,60))
        self.photoimg_left=ImageTk.PhotoImage(img_left)

        f_lbl=Label(left_frame,image=self.photoimg_left)
        f_lbl.place(x=5,y=0,width=750,height=60)

        left_inside_frame=Frame(left_frame,bd=2, relief=RIDGE,bg="white")
        left_inside_frame.place(x=5,y=135,width=750,height=300)
        ...
        right_frame.place(x=690,y=10,width=660,height=400)

        table_frame=Frame(right_frame,bd=2,relief=RIDGE,bg="white")
        table_frame.place(x=5,y=5,width=650,height=400)
